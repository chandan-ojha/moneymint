<div x-show="open"
    ...
    <div class="bg-white min-w-[500px] rounded-md shadow-md">
        ...
        <div class="flex items-center justify-between py-2 px-3 border-b bg-gray-200 rounded-t-md">
            <h5 class="text-md font-semibold font-sans" x-text="modalTitle"></h5>
            <svg @click="resetForm(); open = false" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <!-- Modal Body -->
        <form x-ref="financeForm"
            :action="modalTitle === 'Add Income' ? '{{ route('add-income') }}' : '{{ route('add-expense') }}'"
            ...
            <div class="p-5">
                ...
                <input type="date" name="date" id="income-date"
            ...
            <div class="px-5">
                ...
                <input placeholder="Enter details" type="text" name="details" id="income-description"
                    class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-300 focus:ring-gray-300 block w-full rounded-md text-sm focus:ring-1">
            </div>
            <div class="p-5">
                ...
                <input placeholder="Enter amount" type="number" name="amount" id="income-amount"
                    class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-300 focus:ring-gray-300 block w-full rounded-md text-sm focus:ring-1">
            </div>
        </form>
        <!--End Modal Body -->
        ...
        <div class="flex gap-2 border-t py-3 justify-center">
            <button @click="resetForm(); open = false"
            ...
            <button type="submit" @click="$refs.financeForm.submit()"
